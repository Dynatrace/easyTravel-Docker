#!/bin/bash
ET_PROBLEMS=${ET_PROBLEMS:-'BadCacheSynchronization,CPULoad,DatabaseCleanup,FetchSizeTooSmall,JourneySearchError404,JourneySearchError500,LoginProblems,MobileErrors,TravellersOptionBox'}
